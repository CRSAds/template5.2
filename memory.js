...
const iconSets = {
  ...
  ebike: [
  'ebike1.png', 'ebike1.png',
  'ebike2.png', 'ebike2.png',
  'ebike3.png', 'ebike3.png',
  'ebike4.png', 'ebike4.png',
  ...
  soda: [
    ...
    'drink.png', 'drink.png',
    'soda.png', 'soda.png',
    'soft-drink-can.png', 'soft-drink-can.png',
    'soft-drink-glass.png', 'soft-drink-glass.png',
    'soft-drink.png', 'soft-drink.png'
  ],
    beauty: [
...
function createCard(src) {
  ...
  card.innerHTML = `
    <div class="front">
      <img src="https://template5-2.vercel.app/assets/card-icon.png" alt="">
    </div>
    <div class="back">
      <img src="https://template5-2.vercel.app/assets/${selectedSetName}/${src}" alt="">
    </div>
  `;
